...
func (*MsgUpdateParams) Descriptor() ([]byte, []int) {
	return fileDescriptor_77bbdca6d94ae660, []int{0}
}
...
func (*MsgUpdateParamsResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_77bbdca6d94ae660, []int{1}
}
...
func init() {
	proto.RegisterType((*MsgUpdateParams)(nil), "sppt.sppt.MsgUpdateParams")
	proto.RegisterType((*MsgUpdateParamsResponse)(nil), "sppt.sppt.MsgUpdateParamsResponse")
}

func init() { proto.RegisterFile("sppt/sppt/tx.proto", fileDescriptor_77bbdca6d94ae660) }

var fileDescriptor_77bbdca6d94ae660 = []byte{
	// 312 bytes of a gzipped FileDescriptorProto
	0x1f, 0x8b, 0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x02, 0xff, 0xe2, 0x12, 0x2a, 0x2e, 0x28, 0x28,
	...
	0xf7, 0x30, 0x92, 0x33, 0xf4, 0x01, 0x00, 0x00,
}
...
func (c *msgClient) UpdateParams(ctx context.Context, in *MsgUpdateParams, opts ...grpc.CallOption) (*MsgUpdateParamsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/sppt.sppt.Msg/UpdateParams", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_UpdateParams_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/sppt.sppt.Msg/UpdateParams",
	}
