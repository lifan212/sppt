...
func (*QueryParamsRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_29f168fe3a07a4d4, []int{0}
}
...
func (*QueryParamsResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_29f168fe3a07a4d4, []int{1}
}
...
func init() {
	proto.RegisterType((*QueryParamsRequest)(nil), "sppt.sppt.QueryParamsRequest")
	proto.RegisterType((*QueryParamsResponse)(nil), "sppt.sppt.QueryParamsResponse")
}

func init() { proto.RegisterFile("sppt/sppt/query.proto", fileDescriptor_29f168fe3a07a4d4) }

var fileDescriptor_29f168fe3a07a4d4 = []byte{
	// 289 bytes of a gzipped FileDescriptorProto
	0x1f, 0x8b, 0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x02, 0xff, 0xe2, 0x12, 0x2d, 0x2e, 0x28, 0x28,
	...
	0x1c, 0x06, 0xc6, 0x80, 0x00, 0x00, 0x00, 0xff, 0xff, 0xee, 0x98, 0x25, 0x53, 0xb2, 0x01, 0x00,
	0x00,
}
...
func (c *queryClient) Params(ctx context.Context, in *QueryParamsRequest, opts ...grpc.CallOption) (*QueryParamsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/sppt.sppt.Query/Params", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_Params_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/sppt.sppt.Query/Params",
	}
...
var _Query_serviceDesc = grpc.ServiceDesc{
	...
	Metadata: "sppt/sppt/query.proto",
}
